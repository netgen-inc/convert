						       ...
						       if (results && results.length > 0 && results[0]['id'] == _id) {
						      	...
						      	for(var i=0;i<content.length;i++){
						      		...
						      		if(content[i].length>11){						      			
						      			...
						      			//第一次如果行内容长度大于15，出现需要处理的词汇，并且词汇的位置在5以内则进行截取
						      			var bNext = true;
						      	...
						      	if(cc.length>0){
							      	...
							      	if(sv.length>130){
							      		...
							      		var nIndex11 = sv.lastIndexOf("."); //句号标志
							      		...
							      		if(nIndex1!=-1){
								      		...
								      		if(nIndex2!=-1 && nIndex>100){ //逗号位置大于100
								      			sv = sv.substring(0,nIndex2)+"...";
								      		}else{
								      			sv = sv.substring(0,128)+"...";
								      		}		
